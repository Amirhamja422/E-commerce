...
<?php 
  ...
  if(isset($_SESSION['customer_email'])){
  	echo "<b>Welcome:</b>".$_SESSION['customer_email'] ."<b style='color:yellow;'>You</b>";
  }else{
...
<div class="d-flex" style="margin-left:264px;background: red;height: 43px;margin-top: -33px;">
Total Item:<h1 style="margin-top: 4px;margin-left: 8px;font-size: 15px;"><?php echo total_items(); ?></h1>
Total Price:<h1 style="margin-top: 4px;margin-left: 8px;font-size: 15px;"><?php echo total_price(); ?></h1>

<a class="nav-link" href="product_cart.php" style=" background: yellow;border: 1px solid;margin-left: 51px;
">Go to cart</a>
</div>

<?php 
    if(isset($_SESSION['customer_email'])){
     echo "<a href ='customer_checkout.php'>login</a>";
    }else{
     echo "<a href ='customer_login.php'>Logout</a>";
